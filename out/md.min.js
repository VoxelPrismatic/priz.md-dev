...
syntax = syntax_alias__[syntax];fn = syntax_alias__[syntax];if(fn == undefined) {console.warn(`Loading syntax highlighting for '${syntax}' on the fly`);fetch(`https://voxelprismatic.github.io/priz.md-dev/out/lang/${syntax}-lang.min.js`).then(resp => resp.text().then(code => {eval(code);console.info(`Finished loading syntax highlighting for '${syntax}'`);});)
;redefine_aliases__();}
str += fn(code);}
