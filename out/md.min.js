...
if(!(st.endsWith("\n")))
st += "\n";st = st.replace(/\\ *\n/gm, "");var str = "";var py = "";var table = "";var ol = "";var ul = "";var quoted = "";var dropper = "";var syntax = "";var code = "";var incode = false;var indropper = false;var intable = false;for(var line of st.split("\n")) {
...
else {str += `<div class="code">`;try {var fn = syntax_alias[syntax];if(typeof fn == "string") {fn = syntax_alias[fn];}
str += fn(code);}
