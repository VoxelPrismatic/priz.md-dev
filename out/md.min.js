...
return st;}
function mark_page(st) {if(!(st.endsWith("\n")))
...
if(m[x] !="#")
break;var id=p1.replace(/[^\w\d]/gm,"").trim();var st=`<h${x} onclick="linkMe(this);"`;st+=`id="${id}">#] ${p1}</h${x}>`;return st;}
...
function mk_ol(st) {var str="<ol>";st=mark_page(st);for(var line of st.split("<br>")) {if(line) {str+="<li>"+line+"</li>";}}
return str+"</ol><br>"}
function mk_ul(st) {var str="<ul>";st=mark_page(st);for(var line of st.split("<br>")) {if(line) {str+="<li>"+line+"</li>";}}
return str+"</ul><br>"}
