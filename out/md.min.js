...
syntax = syntax_alias__[syntax];fn = syntax_alias__[syntax];globalThis.syntax__ = syntax;if(fn == undefined) {console.warn(`Loading syntax highlighting for '${syntax__}' on the fly`);fetch(`https://voxelprismatic.github.io/priz.md-dev/out/lang/${syntax__}-lang.min.js`).then(resp => resp.text().then(code => {globalThis.eval(code);console.info(`Finished loading syntax highlighting for '${syntax__}'`);}))
